...
public:
    ...
    int is_placed;
    bool was_listed;
    // Pøidán výchozí konstruktor pro podporu default-inicializace
    SpellMapEventUnitRec() : unit(nullptr), is_placed(0), was_listed(false) {}
    SpellMapEventUnitRec(MapUnit* unit) : unit(unit), is_placed(0), was_listed(false) {}
};
